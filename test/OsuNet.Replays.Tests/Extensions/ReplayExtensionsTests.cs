...
namespace OsuNet.Replays.Tests.Extensions {
    public class ReplayExtensionsTests {
        [Fact]
        public async Task Decode_EmptyContent_ShouldReturnEmptyReplayData() {
            // Arrange
            var replay = new Replay(Content: "", Encoding: "LZMA");

            // Act
            var result = replay.Decode();
        ...
        [Fact]
        public async Task Decode_ValidContent_ShouldParseFramesAndAccumulateTime() {
            // Arrange
        ...
        [Fact]
        public async Task Decode_ContentWithSeedMarker_ShouldParseSeed() {
            // Arrange
        ...
        [Fact]
        public async Task Decode_ContentWithInvalidFrame_ShouldSkipInvalidFrame() {
            // Arrange
        ...
        [Fact]
        public async Task Decode_ContentWithEmptySegments_ShouldSkipEmpty() {
            // Arrange
